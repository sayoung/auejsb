...
class PdfFacture extends ControllerBase {
...
<style>        
	...
	<div style="width: 100%; overflow: hidden; ">
			...
			<table>
				<tbody>
					<tr>
						<td style="border: 0px solid transparent; font-size:10px;with:100%;text-align:center;margin-top:20px;" >
						<br/><div class="black">Royaume du Maroc</div>
...
<div style="margin-left:15px;" style="width:100%;text-align:left;">
				...
				<br/><br/><br/>
				<div style="margin-left:15px;" style="width:100%;text-align:left;">
					<span class="lotissement-bold">Mode de Règlement : '. $mode_reglement .' </span>
				</div>
				<br/><br/><br/>
